...
import com.example.updatetools.util.SignMd5Util
...
internal object DownloadAppUtils {
    ...
    fun download() {
        ...
        (updateInfo.config.apkSavePath.isNotEmpty()).yes {
            ...
            filePath = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P){
                context.getExternalFilesDir("appUpdate")!!.absolutePath + "/" + packageName
            }else{
